...
- Keep underlines in working and final replies, including their sans-serif styling. Use the complete short `\(\underline{\textsf{clue with spaces}}\)` pattern below. Both commands can render together: the observed red examples omitted an outer closing brace or math delimiter, while properly closed examples rendered. Keep colours and About in their separate short patterns. User correction — 2026-09-23.
